          ...
          <div className="grid grid-cols-2 md:flex md:gap-16 gap-8 text-sm w-full xl:w-auto xl:justify-end">
            <div className="space-y-3">
              ...
              <ul className="space-y-2 mt-2">
                <li><button onClick={() => window.scrollTo(0,0) || navigate('/legal-notice')} className="text-outline hover:text-[#00d1ff] transition-colors text-xs font-body">Legal Notice</button></li>
                <li><button onClick={() => window.scrollTo(0,0) || navigate('/terms-of-service')} className="text-outline hover:text-[#00d1ff] transition-colors text-xs font-body">Terms of Service</button></li>
                <li><button onClick={() => window.scrollTo(0,0) || navigate('/privacy-policy')} className="text-outline hover:text-[#00d1ff] transition-colors text-xs font-body">Privacy Policy</button></li>
              </ul>
            </div>
            <div className="space-y-3">
              ...
              <ul className="space-y-2 mt-2">
                <li><button onClick={() => window.scrollTo(0,0) || navigate('/how-it-works')} className="text-outline hover:text-[#00d1ff] transition-colors text-xs font-body">How It Works</button></li>
                <li><button onClick={() => window.scrollTo(0,0) || navigate('/insurance-tactics')} className="text-outline hover:text-[#00d1ff] transition-colors text-xs font-body">Insurance Tactics</button></li>
                <li><button onClick={() => window.scrollTo(0,0) || navigate('/your-rights')} className="text-outline hover:text-[#00d1ff] transition-colors text-xs font-body">Your Rights</button></li>
              </ul>
            </div>
            <div className="space-y-3">
              ...
              <ul className="space-y-2 mt-2">
                <li><a className="text-outline hover:text-[#00d1ff] transition-colors text-xs font-body" href="mailto:support@claimcalculator.ai">Contact Us</a></li>
                <li><a className="text-outline hover:text-[#00d1ff] transition-colors text-xs font-body" href="#">Partner With Us</a></li>
                <li><a className="text-outline hover:text-[#00d1ff] transition-colors text-xs font-body" href="#">Support</a></li>
              </ul>
            </div>
          </div>
        </div>
