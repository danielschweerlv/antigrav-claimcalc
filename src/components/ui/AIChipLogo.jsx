...
export default function AIChipLogo({ className = "w-24 h-24" }) {
  return (
    ...
    >
      ...
      {/* Inner Screen */}
      <rect x="32" y="32" width="36" height="36" rx="4" stroke="url(#chipGradient)" strokeWidth="1.5" fill="#00d1ff" fillOpacity="0.05" />
      ...
      {/* Text Powered */}
      <text x="50" y="62" fontFamily="'Manrope', system-ui, sans-serif" fontWeight="600" fontSize="6" fill="#a4e6ff" textAnchor="middle" opacity="0.8">POWERED</text>
